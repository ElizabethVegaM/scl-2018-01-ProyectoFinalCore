! function(a) {
  ...
  a.fn.rut = function(c) {
    ...
    return this.each(function() {
      var b = a(this);
      b.wrap('<div class="rut-container"></div>'), b.attr('pattern', '[0-9]{1,2}.[0-9]{3}.[0-9]{3}-[0-9Kk]{1}').attr('maxlength', 12), d.required && b.attr('required', 'required'), d.placeholder && b.attr('placeholder', 'RUT'), d.formatear && b.on('blur', function() {
